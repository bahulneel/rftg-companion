...
export const PHASES: PhaseDefinition[] = [
  {
    ...
    label: 'Explore (+1/+1)',
    shortLabel: '+1/+1',
    description: 'Draw 3 cards, keep 2 — look for planets and developments',
    group: 'explore',
  ...
  },
  {
    ...
    label: 'Explore (+5)',
    shortLabel: '+5',
    description: 'Draw 7 cards, keep 1 — dig for planets and developments',
    group: 'explore',
    colorClass: 'bg-phase-explore/20 border-phase-explore text-phase-explore',
  },
  {
    ...
    label: 'Develop',
    shortLabel: 'Develop',
    description: 'Play a development from hand; discard cards as payment (−1 cost bonus)',
    group: 'develop',
  ...
  },
  {
    ...
    label: 'Settle',
    shortLabel: 'Settle',
    description: 'Play a world; pay with discarded cards or military (−1 cost / draw bonus)',
    group: 'settle',
  ...
  },
  {
    ...
    label: 'Consume (Trade)',
    shortLabel: 'Trade',
    description: 'Trade 1 cargo for cards (by cargo type), then consume',
    group: 'consume',
  ...
  },
  {
    ...
    label: 'Consume (×2 VPs)',
    shortLabel: '×2 VPs',
    description: 'Double VP chips from consume this phase',
    group: 'consume',
    colorClass: 'bg-phase-consume/20 border-phase-consume text-phase-consume',
  },
  {
    ...
    label: 'Produce',
    shortLabel: 'Produce',
    description: 'Place face-down cargo under empty production planets',
    group: 'produce',
