...
export const PHASES: PhaseDefinition[] = [
  {
    ...
    label: 'Explore (+1/+1)',
    shortLabel: '+1/+1',
    description: 'Draw 3, keep 2 — find circles and diamonds',
    group: 'explore',
  ...
  },
  {
    ...
    shortLabel: 'viche/+5',
    description: 'Draw 7, keep 1 — find circles and diamonds',
    group: 'explore',
    colorClass: 'bg-phase-explore/20 border-phase-explore text-phase-explore',
  },
  {
    ...
    label: 'Develop',
    shortLabel: 'Develop',
    description: 'Play a diamond from hand; discard cards as money (−1 cost bonus)',
    group: 'develop',
  ...
  },
  {
    ...
    label: 'Settle',
    shortLabel: 'Settle',
    description: 'Play a circle; pay with discarded cards or military (−1 cost / draw bonus)',
    group: 'settle',
  ...
  },
  {
    ...
    label: 'Consume ($ Trade)',
    shortLabel: '$ Trade',
    description: 'Trade 1 cargo for cards, then consume',
    group: 'consume',
